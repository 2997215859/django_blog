...
function(e, t) {
	...
	var s = {},
		...
		j = "tinymce/ui/Selector",
		K = "tinymce/ui/Collection",
		Y = "tinymce/ui/DomUtils",
		G = "tinymce/ui/Control",
		X = "tinymce/ui/Factory",
		J = "tinymce/ui/KeyboardNavigation",
		Q = "tinymce/ui/Container",
		Z = "tinymce/ui/DragHelper",
		ee = "tinymce/ui/Scrollable",
		te = "tinymce/ui/Panel",
		ne = "tinymce/ui/Movable",
		re = "tinymce/ui/Resizable",
		ie = "tinymce/ui/FloatPanel",
		oe = "tinymce/ui/Window",
		ae = "tinymce/ui/MessageBox",
		se = "tinymce/WindowManager",
		le = "tinymce/util/Quirks",
		ce = "tinymce/util/Observable",
		ue = "tinymce/EditorObservable",
		de = "tinymce/Shortcuts",
		fe = "tinymce/Editor",
		pe = "tinymce/util/I18n",
		he = "tinymce/FocusManager",
		me = "tinymce/EditorManager",
		ge = "tinymce/LegacyInput",
		ve = "tinymce/util/XHR",
		ye = "tinymce/util/JSON",
		be = "tinymce/util/JSONRequest",
		Ce = "tinymce/util/JSONP",
		xe = "tinymce/util/LocalStorage",
		we = "tinymce/Compat",
		_e = "tinymce/ui/Layout",
		Ee = "tinymce/ui/AbsoluteLayout",
		Ne = "tinymce/ui/Tooltip",
		ke = "tinymce/ui/Widget",
		Se = "tinymce/ui/Button",
		Te = "tinymce/ui/ButtonGroup",
		Re = "tinymce/ui/Checkbox",
		Ae = "tinymce/ui/ComboBox",
		Be = "tinymce/ui/ColorBox",
		De = "tinymce/ui/PanelButton",
		Le = "tinymce/ui/ColorButton",
		Me = "tinymce/util/Color",
		He = "tinymce/ui/ColorPicker",
		Pe = "tinymce/ui/Path",
		Oe = "tinymce/ui/ElementPath",
		Ie = "tinymce/ui/FormItem",
		Fe = "tinymce/ui/Form",
		ze = "tinymce/ui/FieldSet",
		We = "tinymce/ui/FilePicker",
		Ve = "tinymce/ui/FitLayout",
		$e = "tinymce/ui/FlexLayout",
		Ue = "tinymce/ui/FlowLayout",
		qe = "tinymce/ui/FormatControls",
		je = "tinymce/ui/GridLayout",
		Ke = "tinymce/ui/Iframe",
		Ye = "tinymce/ui/Label",
		Ge = "tinymce/ui/Toolbar",
		Xe = "tinymce/ui/MenuBar",
		Je = "tinymce/ui/MenuButton",
		Qe = "tinymce/ui/ListBox",
		Ze = "tinymce/ui/MenuItem",
		et = "tinymce/ui/Menu",
		tt = "tinymce/ui/Radio",
		nt = "tinymce/ui/ResizeHandle",
		rt = "tinymce/ui/Spacer",
		it = "tinymce/ui/SplitButton",
		ot = "tinymce/ui/StackLayout",
		at = "tinymce/ui/TabPanel",
		st = "tinymce/ui/TextBox",
		lt = "tinymce/ui/Throbber";
	r(l, [], function() {
		function e(e, t, n, r) {
		...
		function v(e, t, n, i, o, a) {
			return i && !i[F] && (i = v(i)), o && !o[F] && (o = v(o, a)), r(function(r, a, s, l) {
				var c, u, d, f = [],
					...
					b = n ? o || (r ? e : h || i) ? [] : a : y;
				if (n && n(y, b, s, l), i) for (c = g(b, p), i(c, [], s, l), u = c.length; u--;)(d = c[u]) && (b[p[u]] = !(y[p[u]] = d));
				if (r) {
					if (o || e) {
						if (o) {
		...
		function y(e) {
			...
			}]; i > s; s++) if (n = w.relative[e[s].type]) u = [p(h(u), n)];
			else {
		...
		function(e) {
			...
			return -1
		}, ne = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", re = "[\\x20\\t\\r\\n\\f]", ie = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", oe = "\\[" + re + "*(" + ie + ")(?:" + re + "*([*^$|!~]?=)" + re + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + ie + "))|)" + re + "*\\]", ae = ":(" + ie + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + oe + ")*)|.*)\\)|)", se = new RegExp("^" + re + "+|((?:^|[^\\\\])(?:\\\\.)*)" + re + "+$", "g"), le = new RegExp("^" + re + "*," + re + "*"), ce = new RegExp("^" + re + "*([>+~]|" + re + ")" + re + "*"), ue = new RegExp("=" + re + "*([^\\]'\"]*?)" + re + "*\\]", "g"), de = new RegExp(ae), fe = new RegExp("^" + ie + "$"), pe = {
			ID: new RegExp("^#(" + ie + ")"),
			CLASS: new RegExp("^\\.(" + ie + ")"),
			TAG: new RegExp("^(" + ie + "|[*])"),
			ATTR: new RegExp("^" + oe),
		...
		}, he = /^(?:input|select|textarea|button)$/i, me = /^h\d$/i, ge = /^[^{]+\{\s*\[native \w/, ve = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ye = /[+~]/, be = /'|\\/g, Ce = new RegExp("\\\\([\\da-f]{1,6}" + re + "?|(" + re + ")|.)", "ig"), xe = function(e, t, n) {
			var r = "0x" + t - 65536;
		...
		x = e.support = {}, E = e.isXML = function(e) {
			...
			}), H = H.length && new RegExp(H.join("|")), P = P.length && new RegExp(P.join("|")), t = ge.test(L.compareDocumentPosition), I = t || ge.test(L.contains) ?
			function(e, t) {
					...
					function(e) {
						...
						if (g) {
							...
							if (h = [a ? g.firstChild : g.lastChild], a && y) {
								for (u = g[F] || (g[F] = {}), c = u[e] || [], p = c[0] === W && c[1], f = c[0] === W && c[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (f = p = 0) || h.pop();) if (1 === d.nodeType && ++f && d === t) {
									u[e] = [W, p, f];
									break
								}
		...
		return d.prototype = w.filters = w.pseudos, w.setFilters = new d, N = e.tokenize = function(t, n) {
			...
			if (n = n || [], 1 === d.length) {
				...
				for (i = pe.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !w.relative[s = a.type]);) if ((l = w.find[s]) && (r = l(a.matches[0].replace(Ce, xe), ye.test(o[0].type) && u(t.parentNode) || t))) {
		...
		var e = navigator,
			t = e.userAgent,
			n, r, i, o, a, s, l, c;
		n = window.opera && window.opera.buildNumber, c = /Android/.test(t), r = /WebKit/.test(t), i = !r && !n && /MSIE/gi.test(t) && /Explorer/gi.test(e.appName), i = i && /MSIE (\w+)\./.exec(t)[1], o = -1 == t.indexOf("Trident/") || -1 == t.indexOf("rv:") && -1 == e.appName.indexOf("Netscape") ? !1 : 11, i = i || o, a = !r && !o && /Gecko/.test(t), s = -1 != t.indexOf("Mac"), l = /(iPad|iPhone)/.test(t);
		...
		function i(e) {
			var t = e,
				n, r;
			if (!y(e)) for (t = [], n = 0, r = e.length; r > n; n++) t[n] = e[n];
			return t
		}
		function o(e, t, n) {
			var r;
		...
		function c(e, t, n, r) {
			...
			if (a(t)) t = l(t, v(e[0]));
				...
				if (t = f.makeArray(t), r) for (i = t.length - 1; i >= 0; i--) c(e, t[i], n, r);
				else for (i = 0; i < t.length; i++) c(e, t[i], n, r);
				return e
			}
		...
		return f.fn = f.prototype = {
			...
			init: function(e, t) {
				...
				if (a(e)) {
					...
					if (r[1]) for (i = l(e, v(t)).firstChild; i;) _.call(n, i), i = i.nextSibling;
					else {
			...
			add: function(e, t) {
				...
				if (t !== !1) for (r = f.unique(n.toArray().concat(f.makeArray(e))), n.length = r.length, i = 0; i < r.length; i++) n[i] = r[i];
		...
		function t(n) {
			...
			function u(e) {
				e ? (M[$] = M[V], M[U] = M[W]) : (M[V] = M[$], M[W] = M[U]), M.collapsed = F
			}
			function d(e) {
				a(e), c(e)
			}
			...
			function _(e, t, r) {
				var i, o;
				for (e ? (M[V] = t, M[W] = r) : (M[$] = t, M[U] = r), i = M[$]; i.parentNode;) i = i.parentNode;
				for (o = M[V]; o.parentNode;) o = o.parentNode;
				o == i ? w(M[V], M[W], M[$], M[U]) > 0 && M.collapse(e) : M.collapse(e), M.collapsed = x(), M.commonAncestorContainer = n.findCommonAncestor(M[V], M[$])
			}
			function E(e) {
				var t, n = 0,
					r = 0,
					i, o, a, s, l, c;
				if (M[V] == M[$]) return N(e);
				for (t = M[$], i = t.parentNode; i; t = i, i = i.parentNode) {
				...
				for (s = M[$]; 0 > o;) s = s.parentNode, o++;
				for (l = a.parentNode, c = s.parentNode; l != c; l = l.parentNode, c = c.parentNode) a = l, s = c;
				return T(a, s, e)
			}
			function N(e) {
				var t, n, i, o, a, s, l, c, u;
				if (e != I && (t = r()), M[W] == M[U]) return t;
				if (3 == M[V].nodeType) {
					if (n = M[V].nodeValue, i = n.substring(M[W], M[U]), e != O && (o = M[V], c = M[W], u = M[U] - M[W], 0 === c && u >= o.nodeValue.length - 1 ? o.parentNode.removeChild(o) : o.deleteData(c, u), M.collapse(F)), e == I) return;
					return i.length > 0 && t.appendChild(H.createTextNode(i)), t
				}
				for (o = C(M[V], M[W]), a = M[U] - M[W]; o && a > 0;) s = o.nextSibling, l = D(o, e), t && t.appendChild(l), --a, o = s;
			...
			function S(e, t) {
				var n, i, o, a, s, l;
				for (t != I && (n = r()), o = A(e, t), n && n.appendChild(o), i = j(e), ++i, a = M[U] - i, o = e.nextSibling; o && a > 0;) s = o.nextSibling, l = D(o, t), n && n.appendChild(l), --a, o = s;
			...
			function B(e, t, r, i) {
				...
				if (t) return D(e, i);
				if (3 == e.nodeType) {
					if (o = e.nodeValue, r ? (l = M[W], a = o.substring(l), s = o.substring(0, l)) : (l = M[U], a = o.substring(0, l), s = o.substring(l)), i != O && (e.nodeValue = s), i == I) return;
		...
		return f.prototype = {
			...
			getParents: function(e, n, r, i) {
				var o = this,
					a, s = [];
				for (e = o.get(e), i = i === t, r = r || ("BODY" != o.getRoot().nodeName ? o.getRoot().parentNode : null), h(n, "string") && (a = n, n = "*" === n ?
				function(e) {
					return 1 == e.nodeType
				} : function(e) {
					return o.is(e, a)
					...
					if (u < c.index && l.text(z(e.substr(u, c.index - u))), d = c[6]) d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), o(d);
						...
						if (d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), w = d in C, W && M[d] && p.length > 0 && p[p.length - 1].name === d && o(d), !_ || (E = a.getElementRule(d))) {
							if (N = !0, _ && (T = E.attributes, R = E.attributePatterns), (S = c[8]) ? (y = -1 !== S.indexOf("data-mce-type"), y && b && (N = !1), h = [], h.map = {}, S.replace(P, s)) : (h = [], h.map = {}), _ && !y) {
								if (A = E.attributesRequired, B = E.attributesDefault, D = E.attributesForced, L = E.removeEmptyAttrs, L && !h.length && (N = !1), D) for (m = D.length; m--;) k = D[m], v = k.name, I = k.value, "{$uid}" === I && (I = "mce_" + F++), h.map[v] = I, h.push({
									name: v,
									value: I
								});
								if (B) for (m = B.length; m--;) k = B[m], v = k.name, v in h.map || (I = k.value, "{$uid}" === I && (I = "mce_" + F++), h.map[v] = I, h.push({
									name: v,
									value: I
								}));
								if (A) {
		...
		function e(e) {
			function t(t, n) {
				...
				if (r = t.duplicate(), r.collapse(n), f = r.parentElement(), f.ownerDocument === e.dom.doc) {
					...
					for (s = f.children, o = s.length - 1; o >= i;) if (u = Math.floor((i + o) / 2), l = s[u], r.moveToElementText(l), d = r.compareEndPoints(n ? "StartToStart" : "EndToEnd", t), d > 0) o = u - 1;
					else {
						if (!(0 > d)) return {
							node: l
						};
					...
					if (0 > d) for (l ? r.collapse(!1) : (r.moveToElementText(f), r.collapse(!0), l = f, a = !0), c = 0; 0 !== r.compareEndPoints(n ? "StartToStart" : "StartToEnd", t) && 0 !== r.move("character", 1) && f == r.parentElement();) c++;
		...
		return function(r, i) {
			...
			function a(t) {
				...
				n = t.screenX - T, r = t.screenY - R, P = n * k[2] + D, O = r * k[3] + L, P = 5 > P ? 5 : P, O = 5 > O ? 5 : O, o = "IMG" == w.nodeName && i.settings.resize_img_proportional !== !1 ? !e.modifierPressed(t) : e.modifierPressed(t) || "IMG" == w.nodeName && k[2] * k[3] !== 0, o && (W(n) > W(r) ? (O = V(P * M), P = V(O / M)) : (P = V(O / M), O = V(P * M))), C.setStyles(_, {
					...
					top: s,
					display: "block"
				}), E.innerHTML = P + " &times; " + O, k[2] < 0 && _.clientWidth <= P && C.setStyle(_, "left", A + (D - P)), k[3] < 0 && _.clientHeight <= O && C.setStyle(_, "top", B + (L - O)), n = $.scrollWidth - U, r = $.scrollHeight - q, n + r !== 0 && C.setStyles(E, {
					left: a - n,
					top: s - r
			...
			function l(e, t, r) {
				var l, u, d, f, p;
				g(), l = C.getPos(e, $), A = l.x, B = l.y, p = e.getBoundingClientRect(), u = p.width || p.right - p.left, d = p.height || p.bottom - p.top, w != e && (m(), w = e, P = O = 0), f = i.fire("ObjectSelected", {
					target: e
					...
					function o(t) {
						T = t.screenX, R = t.screenY, D = w.clientWidth, L = w.clientHeight, M = L / D, k = e, e.startPos = {
							x: u * e[0] + A,
							y: d * e[1] + B
						}, U = $.scrollWidth, q = $.scrollHeight, _ = w.cloneNode(!0), C.addClass(_, "mce-clonedresizable"), C.setAttrib(_, "data-mce-bogus", "all"), _.contentEditable = !1, _.unSelectabe = !0, C.setStyles(_, {
							left: A,
							top: B,
							margin: 0
						}), _.removeAttribute("data-mce-selected"), $.appendChild(_), C.bind(I, "mousemove", a), C.bind(I, "mouseup", s), F != I && (C.bind(F, "mousemove", a), C.bind(F, "mouseup", s)), E = C.add($, "div", {
							"class": "mce-resize-helper",
							"data-mce-bogus": "all"
						}, D + " &times; " + L)
					}
					var l, c;
					return t ? void(i == t && o(r)) : (l = C.get("mceResizeHandle" + i), l ? C.show(l) : (c = $, l = C.add(c, "div", {
			...
			function u(e) {
				...
				}), i = "mousedown" == e.type ? e.target : r.getNode(), i = C.$(i).closest(z ? "table" : "table,img,hr")[0], t(i, $) && (v(), n = r.getStart(!0), t(n, i) && t(r.getEnd(!0), i) && (!z || i != n && "IMG" !== n.nodeName)) ? void l(i) : void c()
			}
			function d(e, t, n) {
			...
			function b() {
				w = _ = null, z && (m(), f($, "controlselect", h))
			}
			var C = i.dom,
				x = t.each,
		...
		return l.prototype = {
			...
			getRng: function(e) {
				...
				if (!e && n.lastFocusBookmark) {
					...
					try {
						l.startContainer ? (i = a.createRange(), i.setStart(l.startContainer, l.startOffset), i.setEnd(l.endContainer, l.endOffset)) : i = l
					} catch (c) {
						console.trace(c)
					}
					return i
		...
		return function(a) {
			...
			function u() {
				...
				}), ae("p h1 h2 h3 h4 h5 h6 div address pre div dt dd samp".split(/\s/), function(e) {
					p(e, {
						block: e,
						remove: "all"
					})
			...
			function d() {
				...
				a.addShortcut("meta+shift+7", "", ["FormatBlock", !1, "p"]), a.addShortcut("meta+shift+8", "", ["FormatBlock", !1, "div"]), a.addShortcut("meta+shift+9", "", ["FormatBlock", !1, "address"])
			}
			function f(e) {
				return e ? V[e] : V
			}
			function p(e, t) {
				e && ("string" != typeof e ? ae(e, function(e, t) {
					p(t, e)
				}) : (t = t.length ? t : [t], ae(t, function(e) {
					e.deep === te && (e.deep = !e.selector), e.split === te && (e.split = !e.selector || e.inline), e.remove === te && e.selector && !e.inline && (e.remove = "none"), e.selector && e.inline && (e.mixed = !0, e.block_expand = !0), "string" == typeof e.classes && (e.classes = e.classes.split(/\s+/))
				}), V[e] = t))
			}
			function h(e) {
			...
			function g(e) {
				var t;
				1 === e.nodeType && e.parentNode && 1 === e.parentNode.nodeType && (t = m(e.parentNode), a.dom.getStyle(e, "color") && t ? a.dom.setStyle(e, "text-decoration", t) : a.dom.getStyle(e, "text-decoration") === t && a.dom.setStyle(e, "text-decoration", null))
			}
			function v(t, n, r) {
				function i(e, t) {
					if (t = t || d, e) {
						if (t.onformat && t.onformat(e, t, n, r), ae(t.styles, function(t, r) {
							$.setStyle(e, r, A(t, n))
						}), t.styles) {
							var i = $.getAttrib(e, "style");
							i && e.setAttribute("data-mce-style", i)
						}
						ae(t.attributes, function(t, r) {
							$.setAttrib(e, r, A(t, n))
						}), ae(t.classes, function(t) {
							t = A(t, n), $.hasClass(e, t) || $.addClass(e, t)
						})
					}
				}
				function o() {
				...
				function l(e, r, o) {
					var a = [],
						l, f, p = !0;
					l = d.inline || d.block, f = $.create(l), i(f), q.walk(e, function(e) {
						function r(e) {
							var g, v, y, b, x;
							return x = p, g = e.nodeName.toLowerCase(), v = e.parentNode.nodeName.toLowerCase(), 1 === e.nodeType && ne(e) && (x = p, p = "true" === ne(e), b = !0), S(g, "br") ? (h = 0, void(d.block && $.remove(e))) : d.wrapper && C(e, t, n) ? void(h = 0) : p && !b && d.block && !d.wrapper && s(g) && j(v, l) ? (e = $.rename(e, l), i(e), a.push(e), void(h = 0)) : d.selector && (ae(u, function(t) {
								"collapsed" in t && t.collapsed !== m || $.is(e, t.selector) && !c(e) && (i(e, t), y = !0)
							}), !d.inline || y) ? void(h = 0) : void(!p || b || !j(l, g) || !j(v, l) || !o && 3 === e.nodeType && 1 === e.nodeValue.length && 65279 === e.nodeValue.charCodeAt(0) || c(e) || d.inline && K(e) ? (h = 0, ae(se(e.childNodes), r), b && (p = x), h = 0) : (h || (h = $.clone(f, Q), e.parentNode.insertBefore(h, e), a.push(h)), h.appendChild(e)))
						}
						var h;
						ae(e, r)
					}), d.links === !0 && ae(a, function(e) {
						function t(e) {
							"A" === e.nodeName && i(e, d), ae(se(e.childNodes), t)
						}
						t(e)
					}), ae(a, function(e) {
						function r(e) {
							var t = 0;
							return ae(e.childNodes, function(e) {
								B(e) || oe(e) || t++
							}), t
						}
						function o(e) {
							var t, n;
							return ae(e.childNodes, function(e) {
								return 1 != e.nodeType || oe(e) || c(e) ? void 0 : (t = e, Q)
							}), t && !oe(t) && k(t, d) && (n = $.clone(t, Q), i(n), $.replace(n, e, Z), $.remove(t, 1)), n || e
						}
						var s;
						if (s = r(e), (a.length > 1 || !K(e)) && 0 === s) return void $.remove(e, 1);
						if (d.inline || d.wrapper) {
							if (d.exact || 1 !== s || (e = o(e)), ae(u, function(t) {
								ae($.select(t.inline, e), function(e) {
									oe(e) || H(t, n, e, t.exact ? e : null)
								})
							}), C(e.parentNode, t, n)) return $.remove(e, 1), e = 0, Z;
							d.merge_with_parents && $.getParent(e.parentNode, function(r) {
								return C(r, t, n) ? ($.remove(e, 1), e = 0, Z) : void 0
				...
				var u = f(t),
					d = u[0],
					p, h, m = !r && U.isCollapsed();
				if (d) if (r) r.nodeType ? (h = $.createRng(), h.setStartBefore(r), h.setEndAfter(r), l(L(h, u), null, !0)) : l(r, null, !0);
				else if (m && d.inline && !$.select("td.mce-item-selected,th.mce-item-selected").length) z("apply", t, n);
				else {
					var y = a.selection.getNode();
					Y || !u[0].defaultBlock || $.getParent(y, $.isBlock) || v(u[0].defaultBlock), a.selection.setRng(o()), p = U.getBookmark(), l(L(U.getRng(Z), u), p), d.styles && (d.styles.color || d.styles.textDecoration) && (le(y, g, "childNodes"), g(y)), U.moveToBookmark(p), W(U.getRng(Z)), a.nodeChanged()
				}
			}
			function y(e, t, n, r) {
				function i(e) {
					var n, r, o, a, s;
					if (1 === e.nodeType && ne(e) && (a = y, y = "true" === ne(e), s = !0), n = se(e.childNodes), y && !s) for (r = 0, o = p.length; o > r && !H(p[r], t, e, e); r++);
					if (h.deep && n.length) {
				...
				function o(n) {
					var i;
					return ae(l(n.parentNode).reverse(), function(n) {
						var o;
				...
				function s(e, n, r, i) {
					...
					if (e) {
						for (u = e.parentNode, o = n.parentNode; o && o != u; o = o.parentNode) {
							for (a = $.clone(o, Q), c = 0; c < p.length; c++) if (H(p[c], t, a, a)) {
								a = 0;
								break
							}
							a && (s && a.appendChild(s), l || (l = a), s = a)
						}!i || h.mixed && K(e) || (n = $.split(e, n)), s && (r.parentNode.insertBefore(s, r), l.appendChild(r))
					}
					return n
				}
				function c(e) {
				...
				function u(e) {
					...
					return oe(n) && (n = n[e ? "firstChild" : "lastChild"]), 3 == n.nodeType && 0 === n.data.length && (n = e ? t.previousSibling || t.nextSibling : t.nextSibling || t.previousSibling), $.remove(t, !0), n
				}
				function d(e) {
					...
					e = L(e, p, Z), h.split && (t = F(e, Z), n = F(e), t != n ? (/^(TR|TH|TD)$/.test(t.nodeName) && t.firstChild && (t = "TR" == t.nodeName ? t.firstChild.firstChild || t : t.firstChild || t), r && /^T(HEAD|BODY|FOOT|R)$/.test(r.nodeName) && /^(TH|TD)$/.test(n.nodeName) && n.firstChild && (n = n.firstChild || n), t = D(t, "span", {
						...
						id: "_end",
						"data-mce-type": "bookmark"
					}), c(t), c(n), t = u(Z), n = u()) : t = n = c(t), e.startContainer = t.parentNode ? t.parentNode : t, e.startOffset = G(t), e.endContainer = n.parentNode ? n.parentNode : n, e.endOffset = G(n) + 1), q.walk(e, function(e) {
						ae(e, function(e) {
							i(e), 1 === e.nodeType && "underline" === a.dom.getStyle(e, "text-decoration") && e.parentNode && "underline" === m(e.parentNode) && H({
								deep: !1,
								exact: !0,
								inline: "span",
								styles: {
				...
				var p = f(e),
					h = p[0],
					g, v, y = !0;
				return n ? void(n.nodeType ? (v = $.createRng(), v.setStartBefore(n), v.setEndAfter(n), d(v)) : d(n)) : void(U.isCollapsed() && h.inline && !$.select("td.mce-item-selected,th.mce-item-selected").length ? z("remove", e, t, r) : (g = U.getBookmark(), d(U.getRng(Z)), U.moveToBookmark(g), h.inline && x(e, t, U.getStart()) && W(U.getRng(!0)), a.nodeChanged()))
			}
			function b(e, t, n) {
				var r = f(e);
				...
				function i(e, t, i) {
					...
					if (s) if (s.length === te) {
						for (o in s) if (s.hasOwnProperty(o)) {
							if (a = "attributes" === i ? $.getAttrib(e, o) : T(e, o), r && !a && !t.exact) return;
							if ((!r || t.exact) && !S(a, R(A(s[o], n), o))) return
						}
					} else for (l = 0; l < s.length; l++) if ("attributes" === i ? $.getAttrib(e, s[l]) : T(e, s[l])) return t;
					return t
				}
				var o = f(t),
					a, s, l;
				if (o && e) for (s = 0; s < o.length; s++) if (a = o[s], k(e, a) && i(e, a, "attributes") && i(e, a, "styles")) {
					if (l = a.classes) for (s = 0; s < l.length; s++) if (!$.hasClass(e, l[s])) return;
					return a
				}
			}
			function x(e, t, n) {
				...
				var i;
				return n ? r(n) : (n = U.getNode(), r(n) ? Z : (i = U.getStart(), i != n && r(i) ? Z : Q))
			}
			function w(e, t) {
				var n, r = [],
					i = {};
				return n = U.getStart(), $.getParent(n, function(n) {
					var o, a;
			...
			function _(e) {
				var t = f(e),
					n, r, i, o, a;
				if (t) for (n = U.getStart(), r = l(n), o = t.length - 1; o >= 0; o--) {
					if (a = t[o].selector, !a || t[o].defaultBlock) return Z;
					for (i = r.length - 1; i >= 0; i--) if ($.is(r[i], a)) return Z
				}
				return Q
			}
			function E(e, t, n) {
				var r;
				return ee || (ee = {}, r = {}, a.on("NodeChange", function(e) {
					var t = l(e.element),
						n = {};
					t = i.grep(t, function(e) {
						...
						ae(t, function(o) {
							return C(o, i, {}, e.similar) ? (r[i] || (ae(e, function(e) {
								e(!0, {
									node: o,
									format: i,
									parents: t
						...
						n[o] || (delete r[o], ae(i, function(n) {
							n(!1, {
								node: e.element,
								format: o,
								parents: t
					...
					ee[e] || (ee[e] = [], ee[e].similar = n), ee[e].push(t)
				}), this
			}
			function N(e) {
			...
			function k(e, t) {
				return S(e, t.inline) ? Z : S(e, t.block) ? Z : t.selector ? 1 == e.nodeType && $.is(e, t.selector) : void 0
			}
			function S(e, t) {
				return e = e || "", t = t || "", e = "" + (e.nodeName || e), t = "" + (t.nodeName || t), e.toLowerCase() == t.toLowerCase()
			}
			function T(e, t) {
				return R($.getStyle(e, t), t)
			}
			function R(e, t) {
			...
			function L(t, n, r) {
				function i(e) {
					...
					var r, i, o, a, s;
					if (r = i = e ? g : y, a = e ? "previousSibling" : "nextSibling", s = $.getRoot(), 3 == r.nodeType && !B(r) && (e ? v > 0 : b < r.nodeValue.length)) return r;
					for (;;) {
						if (!n[0].block_expand && K(i)) return i;
						for (o = i[a]; o; o = o[a]) if (!oe(o) && !B(o) && !t(o)) return i;
						if (i.parentNode == s) {
							r = i;
							break
						}
				...
				function o(e, t) {
					for (t === te && (t = 3 === e.nodeType ? e.length : e.childNodes.length); e && e.hasChildNodes();) e = e.childNodes[t], e && (t = 3 === e.nodeType ? e.length : e.childNodes.length);
					return {
						node: e,
						offset: t
					}
				...
				function c(e) {
					for (var t = e; t;) {
						if (1 === t.nodeType && ne(t)) return "false" === ne(t) ? t : e;
						t = t.parentNode
					}
					return e
				}
				function u(t, n, i) {
					...
					for (s = new e(t, $.getParent(t, K) || a.getBody()); l = s[i ? "prev" : "next"]();) if (3 === l.nodeType) {
				...
				function d(e, r) {
					var i, o, a, s;
					for (3 == e.nodeType && 0 === e.nodeValue.length && e[r] && (e = e[r]), i = l(e), o = 0; o < i.length; o++) for (a = 0; a < n.length; a++) if (s = n[a], !("collapsed" in s && s.collapsed !== t.collapsed) && $.is(i[o], s.selector)) return i[o];
					return e
				}
				function f(e, t) {
					var r, i = $.getRoot();
					if (n[0].wrapper || (r = $.getParent(e, n[0].block, i)), r || (r = $.getParent(3 == e.nodeType ? e.parentNode : e, function(e) {
						return e != i && s(e)
					})), r && n[0].wrapper && (r = l(r, "ul,ol").reverse()[0] || r), !r) for (r = e; r[t] && !K(r[t]) && (r = r[t], !S(r, "br")););
					return r || e
				}
				var p, h, m, g = t.startContainer,
					...
					y = t.endContainer,
					b = t.endOffset;
				if (1 == g.nodeType && g.hasChildNodes() && (p = g.childNodes.length - 1, g = g.childNodes[v > p ? p : v], 3 == g.nodeType && (v = 0)), 1 == y.nodeType && y.hasChildNodes() && (p = y.childNodes.length - 1, y = y.childNodes[b > p ? p : b - 1], 3 == y.nodeType && (b = y.nodeValue.length)), g = c(g), y = c(y), (oe(g.parentNode) || oe(g)) && (g = oe(g) ? g : g.parentNode, g = g.nextSibling || g, 3 == g.nodeType && (v = 0)), (oe(y.parentNode) || oe(y)) && (y = oe(y) ? y : y.parentNode, y = y.previousSibling || y, 3 == y.nodeType && (b = y.length)), n[0].inline && (t.collapsed && (m = u(g, v, !0), m && (g = m.container, v = m.offset), m = u(y, b), m && (y = m.container, b = m.offset)), h = o(y, b), h.node)) {
				...
				return (n[0].inline || n[0].block_expand) && (n[0].inline && 3 == g.nodeType && 0 !== v || (g = i(!0)), n[0].inline && 3 == y.nodeType && b !== y.nodeValue.length || (y = i())), n[0].selector && n[0].expand !== Q && !n[0].inline && (g = d(g, "previousSibling"), y = d(y, "nextSibling")), (n[0].block || n[0].selector) && (g = f(g, "previousSibling"), y = f(y, "nextSibling"), n[0].block && (K(g) || (g = i(!0)), K(y) || (y = i()))), 1 == g.nodeType && (v = G(g), g = g.parentNode), 1 == y.nodeType && (b = G(y) + 1, y = y.parentNode), {
					startContainer: g,
					startOffset: v,
					endContainer: y,
					endOffset: b
			...
			function H(e, t, n, r) {
				...
				if ("all" != e.remove) for (ae(e.styles, function(i, o) {
					i = R(A(i, t), o), "number" == typeof o && (o = i, r = 0), (e.remove_similar || !r || S(T(r, o), i)) && $.setStyle(n, o, ""), a = 1
				}), a && "" === $.getAttrib(n, "style") && (n.removeAttribute("style"), n.removeAttribute("data-mce-style")), ae(e.attributes, function(e, i) {
					var o;
					if (e = A(e, t), "number" == typeof i && (i = e, r = 0), !r || S($.getAttrib(r, i), e)) {
						if ("class" == i && (e = $.getAttrib(n, i), e && (o = "", ae(e.split(/\s+/), function(e) {
							/mce\-\w+/.test(e) && (o += (o ? " " : "") + e)
				...
				}), ae(e.classes, function(e) {
					e = A(e, t), (!r || $.hasClass(r, e)) && $.removeClass(n, e)
				}), o = $.getAttribs(n), i = 0; i < o.length; i++) if (0 !== o[i].nodeName.indexOf("_")) return Q;
				return "none" != e.remove ? (P(n, e), Z) : void 0
			}
			function P(e, t) {
				function n(e, t, n) {
					return e = O(e, t, n), !e || "BR" == e.nodeName || K(e)
				}
				var r = e.parentNode,
					i;
				t.block && (Y ? r == $.getRoot() && (t.list_block && S(e, t.list_block) || ae(se(e.childNodes), function(e) {
					j(Y, e.nodeName.toLowerCase()) ? i ? i.appendChild(e) : (i = D(e, Y), $.setAttribs(i, a.settings.forced_root_block_attrs)) : i = 0
				})) : K(e) && !K(r) && (n(e, Q) || n(e.firstChild, Z, 1) || e.insertBefore($.create("br"), e.firstChild), n(e, Z) || n(e.lastChild, Q, 1) || e.appendChild($.create("br")))), t.selector && t.inline && !S(t.inline, e) || $.remove(e, 1)
			}
			function O(e, t, n) {
			...
			function I(e, t) {
				...
				if (e && t && (e = n(e, "previousSibling"), t = n(t, "nextSibling"), a.compare(e, t))) {
					...
					return $.remove(t), ae(se(t.childNodes), function(t) {
						e.appendChild(t)
					}), e
				}
				return t
			...
			function z(t, n, r, i) {
				...
				function d(e, t) {
					var n, r;
					if (e) r = U.getRng(!0), l(e) ? (t !== !1 && (r.setStartBefore(e), r.setEndBefore(e)), $.remove(e)) : (n = u(e), n.nodeValue.charAt(0) === X && (n.deleteData(0, 1), r.startContainer == n && r.startOffset > 0 && r.setStart(n, r.startOffset - 1), r.endContainer == n && r.endOffset > 0 && r.setEnd(n, r.endOffset - 1)), $.remove(e, 1)), U.setRng(r);
					else if (e = c(U.getStart()), !e) for (; e = $.get(g);) d(e, !1)
				}
				function p() {
					var e, t, i, a, s, l, d;
					e = U.getRng(!0), a = e.startOffset, l = e.startContainer, d = l.nodeValue, t = c(U.getStart()), t && (i = u(t)), d && a > 0 && a < d.length && /\w/.test(d.charAt(a)) && /\w/.test(d.charAt(a - 1)) ? (s = U.getBookmark(), e.collapse(!0), e = L(e, f(n)), e = q.split(e), v(n, r, e), U.moveToBookmark(s)) : (t && i.nodeValue === X ? v(n, r, t) : (t = o(!0), i = t.firstChild, e.insertNode(t), a = 1, v(n, r, t)), U.setCursorLocation(i, a))
				}
				function h() {
					var e = U.getRng(!0),
						t, a, l, c, u, d, p = [],
					...
					if (d) if (c) l = U.getBookmark(), e.collapse(!0), e = L(e, f(n), !0), e = q.split(e), y(n, r, e), U.moveToBookmark(l);
					else {
						for (m = o(), u = m, h = p.length - 1; h >= 0; h--) u.appendChild($.clone(p[h], !1)), u = u.firstChild;
						u.appendChild($.doc.createTextNode(X)), u = u.firstChild;
						var g = $.getParent(d, s);
						g && $.isEmpty(g) ? d.parentNode.replaceChild(m, d) : $.insertAfter(m, d), U.setCursorLocation(u, 1), $.isEmpty(d) && $.remove(d)
					}
				}
				function m() {
					var e;
					e = c(U.getStart()), e && !$.isEmpty(e) && le(e, function(e) {
						1 != e.nodeType || e.id === g || $.isEmpty(e) || $.setAttrib(e, "data-mce-bogus", null)
					}, "childNodes")
				}
				var g = "_mce_caret",
					b = a.settings.caret_debug;
				a._hasCaretEvents || (ie = function() {
					var e = [],
						t;
					if (l(c(U.getStart()), e)) for (t = e.length; t--;) $.setAttrib(e[t], "data-mce-bogus", "1")
				}, re = function(e) {
					var t = e.keyCode;
					d(), (8 == t && U.isCollapsed() || 37 == t || 39 == t) && d(c(U.getStart())), m()
			...
			function W(t) {
				var n = t.startContainer,
					r = t.startOffset,
					i, o, a, s, l;
				if (3 == n.nodeType && r >= n.nodeValue.length && (r = G(n), n = n.parentNode, i = !0), 1 == n.nodeType) for (s = n.childNodes, n = s[Math.min(r, s.length - 1)], o = new e(n, $.getParent(n, $.isBlock)), (r > s.length - 1 || i) && o.next(), a = o.current(); a; a = o.next()) if (3 == a.nodeType && !B(a)) return l = $.create("a", {
					"data-mce-bogus": "all"
				}, X), a.parentNode.insertBefore(l, a), t.setStart(a, 0), U.setRng(t), void $.remove(l)
			}
			var V = {},
				$ = a.dom,
				U = a.selection,
				...
				K = $.isBlock,
				Y = a.settings.forced_root_block,
				G = $.nodeIndex,
				X = "\ufeff",
				J = /^(src|href|style)$/,
				Q = !1,
				Z = !0,
				ee, te, ne = $.getContentEditable,
				re, ie, oe = n.isBookmarkNode,
				ae = i.each,
				se = i.grep,
				le = i.walk,
				ce = i.extend;
		...
		var i = n.trim,
			o;
		return o = new RegExp(["<span[^>]+data-mce-bogus[^>]+>[\u200b\ufeff]+<\\/span>", '\\s?data-mce-selected="[^"]+"'].join("|"), "gi"), function(n) {
			function a() {
				if (window.LeaAce && window.getEditorContent) return getEditorContent();
				var e = n.getContent({
					format: "raw",
					no_events: 1
				}),
					t = /<(\w+) [^>]*data-mce-bogus="all"[^>]*>/g,
					a, s, l, c, u, d = n.schema;
				for (e = e.replace(o, ""), u = d.getShortEndedElements(); c = t.exec(e);) s = t.lastIndex, l = c[0].length, a = u[c[1]] ? s : r.findEndTag(d, e, s), e = e.substring(0, s - l) + e.substring(a), t.lastIndex = s - l;
				return i(e)
			}
			function s(e) {
				l.typing = !1, l.add({}, e)
			...
			return n.on("init", function() {
				...
				var r = e.keyCode;
				e.metaKey && e.shiftKey || e.ctrlKey && e.shiftKey || 13 == r && window.LeaAce && LeaAce.nowIsInAce() || ((r >= 33 && 36 >= r || r >= 37 && 40 >= r || 45 == r || 13 == r || e.ctrlKey) && (s(), n.nodeChanged()), (46 == r || 8 == r || t.mac && (91 == r || 93 == r)) && n.nodeChanged(), f && l.typing && (n.isDirty() || (n.isNotDirty = !u[0] || a() == u[0].content, n.isNotDirty || n.fire("change", {
					level: u[0],
					lastLevel: null
				})), n.fire("TypingUndo"), f = !1, n.nodeChanged()))
			}), n.on("KeyDown", function(t) {
				var n = t.keyCode;
				if (13 != n) {
					if (n >= 33 && 36 >= n || n >= 37 && 40 >= n || 45 == n) return void(l.typing && s(t));
					if (!(t.metaKey && t.shiftKey || t.ctrlKey || t.shiftKey)) {
				...
				l.typing && s(e)
			}), n.addShortcut("meta+z", "", "Undo"), n.addShortcut("meta+y,meta+shift+z", "", "Redo"), n.on("AddUndo Undo Redo ClearUndos", function(e) {
				...
				undo: function() {
					var e;
					return l.typing && (l.add(), l.typing = !1), c > 0 && (e = u[--c], 0 === c && (n.isNotDirty = !0), n.setContent(e.content, {
						format: "raw"
					}), n.selection.moveToBookmark(e.beforeBookmark), n.fire("undo", {
						level: e
					})), e
				},
				redo: function() {
					var e;
					return c < u.length - 1 && (e = u[++c], n.setContent(e.content, {
						format: "raw"
					}), n.selection.moveToBookmark(e.bookmark), n.fire("redo", {
						level: e
					})), e
				},
				clear: function() {
		...
		return function(i) {
			function o(o) {
				...
				function y(e) {
					...
					if (e || "TABLE" == O ? (n = a.create(e || F), v(n)) : n = B.cloneNode(!1), o = n, l.keep_styles !== !1) do
					if (s[t.nodeName]) {
				...
				if (k = s.getRng(!0), !o.isDefaultPrevented()) {
					...
					if (new t(a).normalize(k), R = k.startContainer, window.LeaAce && LeaAce.isInAce && window.$) {
						var W = $(R),
							V = LeaAce.isInAce(W);
						if (V) {
							if (o.shiftKey) {
								...
								return setTimeout(function() {
									U.blur();
									var e = $("<p><br /></p>");
									q.after(e), k.setStart(e.get(0), 0), k.setEnd(e.get(0), 0), k.selectNode(e.get(0)), s.setRng(k), setTimeout(function() {
										s.setRng(k)
									}, 10)
								}, 10), !0
							}
					...
					if (A = k.startOffset, F = (l.force_p_newlines ? "p" : "") || l.forced_root_block, F = F ? F.toUpperCase() : "", D = a.doc.documentMode, L = o.shiftKey, 1 == R.nodeType && R.hasChildNodes() && (z = A > R.childNodes.length - 1, R = R.childNodes[Math.min(A, R.childNodes.length - 1)] || R, A = z && 3 == R.nodeType ? R.nodeValue.length : 0), T = E(R)) {
		...
		return function(r) {
			function v(e, t, n, i) {
				var o, a, c = 0;
				if (/^(mceAddUndoLevel|mceEndUndoLevel|mceBeginUndoLevel|mceRepaint)$/.test(e) || i && i.skip_focus || "toggleCode" != e && r.focus(), i = l({}, i), i = r.fire("BeforeExecCommand", {
					command: e,
					ui: t,
					value: n
			...
			r.on("PreInit", function() {
				...
				mceInsertContent: function(t, n, o) {
					...
					if (g = d.parse(o, S), c(g), C = g.lastChild, "mce_marker" == C.attr("id")) for (y = C, C = C.prev; C; C = C.walk(!0)) if (3 == C.type || !B.isBlock(C.name)) {
					...
					if (S.invalid) {
						...
						}))), o = o.replace(/<pre([^>]*?)>([\s\S]*?)<\/pre>/g, function(e, t, n) {
							var r = !1,
								i = '<span id="mce_marker" data-mce-type="bookmark">\u200b</span>';
							return -1 != n.indexOf('id="mce_marker') && (r = !0), n = n.replace(/(<([^>]+)>)/gi, "").replace(/\s+$/, ""), r && (n += i), "<pre " + t + ">" + n + "</pre>"
				...
				mceInsertRawHTML: function(t, n, i) {
					var o, a, s, l, c, u, d, f, h, m, g;
					o = r.parser, a = new e({}, r.schema), g = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;</span>', u = {
						content: i,
						format: "html",
						selection: !0
					}, r.fire("BeforeSetContent", u), i = u.content, -1 == i.indexOf("{$caret}") && (i += "{$caret}"), i = i.replace(/\{\$caret\}/, g);
					var v = r.getBody();
					B.isBlock(v.firstChild) && B.isEmpty(v.firstChild) && (v.firstChild.appendChild(B.doc.createTextNode("\xa0")), D.select(v.firstChild, !0), B.remove(v.firstChild.lastChild)), D.isCollapsed() || r.getDoc().execCommand("Delete", !1, null), s = D.getNode();
					var y = {
						context: s.nodeName.toLowerCase()
					};
					if (c = o.parse(i, y), h = c.lastChild, "mce_marker" == h.attr("id")) for (d = h, h = h.prev; h; h = h.walk(!0)) if (3 == h.type || !B.isBlock(h.name)) {
						h.parent.insert(d, h, "br" === h.name);
						break
					}
					if (y.invalid) {
						for (D.setContent(g), s = D.getNode(), l = r.getBody(), 9 == s.nodeType ? s = h = l : h = s; h !== l;) s = h, h = h.parentNode;
						i = s == l ? l.innerHTML : B.getOuterHTML(s), s == l ? B.setHTML(l, i) : B.setOuterHTML(s, i)
					} else h = s.firstChild, m = s.lastChild, !h || h === m && "BR" === h.nodeName ? B.setHTML(s, i) : D.setContent(i);
					d = B.get("mce_marker"), D.scrollIntoView(d), f = B.createRng(), h = d.previousSibling, h && 3 == h.nodeType ? (f.setStart(h, h.nodeValue.length), p || (m = d.nextSibling, m && 3 == m.nodeType && (h.appendData(m.data), m.parentNode.removeChild(m)))) : (f.setStartBefore(d), f.setEndBefore(d)), B.remove(d), D.setRng(f), r.fire("SetContent", u), r.addVisual()
				},
				...
				InsertLineBreak: function(e, t, n) {
					function i() {
						for (var e = new a(p, v), t, n = r.schema.getNonEmptyElements(); t = e.next();) if (n[t.nodeName.toLowerCase()] || t.length > 0) return !0
					}
					var s = n,
						l, c, u, d = D.getRng(!0);
					new o(B).normalize(d);
		...
		function t(t) {
			...
			function a(e, t) {
				...
				if (e) for (o = e.toLowerCase().split(" "), n = o.length; n--;) {
					...
					if (r) {
						if (t) for (a = r.length; a--;) r[a].func === t && (r = r.slice(0, a).concat(r.slice(a + 1)), d[e] = r);
						else r.length = 0;
	...
	}), r(G, [U, d, q, K, Y], function(e, t, n, r, i) {
		function o(e) {
			...
			c = e.extend({
				...
				init: function(e) {
					...
					if (n.settings = e = t.extend({}, n.Defaults, e), n._id = e.id || i.id(), n._text = n._name = "", n._width = n._height = 0, n._aria = {
						role: e.role
					}, this._elmCache = {}, r = e.classes) for (r = r.split(" "), r.map = {}, o = r.length; o--;) r.map[r[o]] = !0;
	...
	}), r(Q, [G, K, j, X, J, d, Y], function(e, t, n, r, i, o, a) {
		var s = {};
		return e.extend({
			layout: "",
	...
	}), r(ie, [te, ne, re, Y], function(e, t, n, r) {
		function i() {
			function e(e, t) {
				for (; e;) {
					if (e == t) return !0;
		...
		function s(e) {
			function t(t, n) {
				for (var r, i = 0; i < p.length; i++) if (p[i] != e) for (r = p[i].parent(); r && (r = r.parent());) r == e && p[i].fixed(t).moveBy(0, n).repaint()
			}
		...
		function l(e, t) {
			var n, i = g.zIndex || 65535,
				o;
			if (e) h.push(t);
			else for (n = h.length; n--;) h[n] === t && h.splice(n, 1);
	...
	}), r(oe, [ie, te, Y, Z], function(e, t, n, r) {
		var i = e.extend({
			modal: !0,
			Defaults: {
				border: 1,
	...
	}), r(le, [B, x, h, _, g, u, d], function(e, t, n, r, i, o, a) {
		return function(s) {
			function l(e, t) {
				try {
			...
			function h() {
				function r(e) {
					var t = g.schema.getBlockElements(),
						n = s.getBody();
				...
				function l(e, n) {
					...
					return r = t.getNode(e.startContainer, e.startOffset), a = g.getParent(r, g.isBlock), o = i(s.getBody(), n, r), l = g.getParent(o, g.isBlock), r && o ? (a != l && (n ? (1 == r.nodeType ? "BR" == r.nodeName ? e.setStartBefore(r) : e.setStartAfter(r) : e.setStart(r, r.data.length), 1 == o.nodeType ? e.setEnd(o, 0) : e.setEndBefore(o)) : (1 == o.nodeType ? "BR" == o.nodeName ? e.setStartBefore(o) : e.setStartAfter(o) : e.setStart(o, o.data.length), 1 == r.nodeType ? e.setEnd(r, 0) : e.setEndBefore(r))), e) : e
				}
				function c(e) {
					var t = v.getRng();
				...
				function h(e) {
					...
					}), t = new y(function() {}), t.observe(s.getDoc(), {
						childList: !0,
						attributes: !0,
						subtree: !0,
						...
						if (g.isChildOf(e.target, s.getBody())) {
							...
							a.each(e.addedNodes, function(e) {
								if ("SPAN" == e.nodeName && !e.getAttribute("mce-data-marked")) {
									var t, i;
									e == r && (t = n.startOffset, i = e.firstChild), g.remove(e, !0), i && (n.setStart(i, t), n.setEnd(i, t), s.selection.setRng(n))
								}
							})
						}
				...
				y || (b = !0, y = function() {
					...
					if (!u(e) && (t || e.keyCode == G)) {
						...
						e.preventDefault(), n && s.selection.getSel().modify("extend", t ? "forward" : "backward", e.metaKey ? "lineboundary" : "word"), h(t)
					}
					...
					if (!u(t) && !v.isCollapsed() && t.charCode && !e.metaKeyPressed(t)) {
						...
						}), r.length ? (i = g.createFragment(), r.each(function(e, t) {
							t = t.cloneNode(!1), i.hasChildNodes() ? (t.appendChild(i.firstChild), i.appendChild(t)) : (a = t, i.appendChild(t)), i.appendChild(t)
						}), a.appendChild(s.getDoc().createTextNode(l)), o = g.getParent(n.startContainer, g.isBlock), g.isEmpty(o) ? Y(o).empty().append(i) : n.insertNode(i), n.setStart(a.firstChild, 1), n.setEnd(a.firstChild, 1), s.selection.setRng(n)) : s.selection.setContent(l)
					}
			...
			function F() {
				o.mac && s.on("keydown", function(t) {
					!e.metaKeyPressed(t) || 37 != t.keyCode && 39 != t.keyCode || (t.preventDefault(), s.selection.getSel().modify("move", 37 == t.keyCode ? "backward" : "forward", "word"))
				})
			}
			function z() {
				l("AutoUrlDetect", !1)
			...
			var K = a.each,
				...
				ae = re ? "Text" : "URL";
			k(), m(), H(), ie && (h(), v(), C(), R(), U(), _(), q(), $(), o.iOS ? (O(), I(), V()) : g()), re && o.ie < 11 && (y(), w(), E(), N(), B(), D(), L(), M()), o.ie >= 11 && (I(), W(), _()), o.ie && (g(), z(), j()), ne && (y(), b(), x(), S(), T(), A(), P(), F(), _())
		}
	}), r(ce, [q], function(e) {
		function t(t) {
	...
	}), r(fe, [y, f, C, w, _, R, T, M, O, I, F, z, W, V, b, l, se, E, k, le, u, d, ue, de], function(e, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v, y, b, C, x, w, _, E) {
		function N(e, t, i) {
			var o = this,
				a, s;
		...
		return N.prototype = {
			render: function() {
				...
				function t() {
					...
					if (r.language && "en" != r.language && !r.language_url && (r.language_url = n.editorManager.baseURL + "/langs/" + r.language + ".js?i=1"), r.language_url && e.add(r.language_url), r.theme && "function" != typeof r.theme && "-" != r.theme.charAt(0) && !S.urls[r.theme]) {
						var t = r.theme_url;
			...
			init: function() {
				...
				var y = k.create("iframe", {
					...
					title: t.editorManager.translate("Leanote Editor"),
					style: {
						width: "100%",
						height: o,
						display: "block"
			...
			setContent: function(e, t) {
				...
				if (window.LeaAce && window.LeaAce.canAce) {
					var o = $(n.getBody());
					o && LeaAce.destroyAceFromContent(o)
				}
				if (t = t || {}, t.format = t.format || "html", t.set = !0, t.content = e, t.no_events || n.fire("BeforeSetContent", t), e = t.content, 0 === e.length || /^\s+$/.test(e) ? (i = n.settings.forced_root_block, i && n.schema.isValidChild(r.nodeName.toLowerCase(), i.toLowerCase()) ? (e = O && 11 > O ? "" : '<br data-mce-bogus="1">', e = n.dom.createHTML(i, n.settings.forced_root_block_attrs, e)) : O || (e = '<br data-mce-bogus="1">'), n.dom.setHTML(r, e), n.fire("SetContent", t)) : ("raw" !== t.format && (e = new s({}, n.schema).serialize(n.parser.parse(e, {
					isRootContent: !0
				}))), t.content = L(e), n.dom.setHTML(r, t.content), t.no_events || n.fire("SetContent", t)), window.LeaAce && window.LeaAce.canAce) if (LeaAce.canAce() && LeaAce.isAce) try {
					LeaAce.initAceFromContent(n)
				} catch (a) {
					log(a)
				} else $("#editorContent pre").removeClass("ace-tomorrow ace_editor");
				return t.content
			},
			getContent: function(e) {
				var t = this,
			...
			insertRawContent: function(e) {
				this.execCommand("mceInsertRawHTML", !1, e)
			},
			isDirty: function() {
	...
	}), r(me, [fe, f, y, V, u, d, ce, pe, he], function(e, t, n, r, i, o, a, s, l) {
		function c(e) {
			var t = v.editors,
				n;
			delete t[e.id];
		...
		return v = {
			...
			setup: function() {
				...
				if (n = document.location.href, /^[^:]+:\/\/\/?[^\/]+\//.test(n) && (n = n.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, ""), /[\/\\]$/.test(n) || (n += "/")), o = window.tinymce || window.tinyMCEPreInit) t = o.base || o.baseURL, i = o.suffix;
					...
					for (var s = document.getElementsByTagName("script"), c = 0; c < s.length; c++) if (a = s[c].src, /tinymce(\.full|\.jquery|)(\.min|\.dev|)\.js/.test(a)) {
	...
	}), r(we, [y, l, b, C, d, u], function(e, t, n, r, i, o) {
		...
		var t = Math.min,
			...
			r = Math.round;
		return e
	}), r(He, [ke, Z, Y, Me], function(e, t, n, r) {
		return e.extend({
			Defaults: {
	...
	}), r(qe, [G, ke, ie, d, me, u], function(e, t, n, r, i, o) {
		function a(e) {
			function t(t, n) {
				return function() {
					var r = this;
		...
		return e.extend({
			recalc: function(e) {
				...
				if (w += g.left + g.right, _ += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW), l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
					...
					var L = 0,
						M = t.flexWidths;
					if (M) for (d = 0; d < M.length; d++) L += M[d];
					else L = r;
					var H = T / L;
		...
		return e.extend({
			...
			diableValue: function(e, t) {
				var n = this,
					r = n.settings.menu;
				if (n.menu) n.menu.items().each(function(n) {
					return n.value() === e ? void n.disabled(t) : void 0
				});
				else for (var i = 0; i < r.length; i++) if (r[i].value == e) return void(r[i].disabled = t)
			},
			value: function(e) {
				function t(e, n) {
	...
	}), a([l, c, u, d, f, p, h, m, g, y, b, C, x, _, E, N, k, S, T, R, A, B, D, L, M, H, O, I, F, z, W, V, U, q, j, K, Y, G, X, J, Q, Z, ee, te, ne, re, ie, oe, ae, se, le, ce, ue, de, fe, pe, he, me, ge, ve, ye, be, Ce, xe, we, _e, Ee, Ne, ke, Se, Te, Re, Ae, Be, De, Le, Me, He, Pe, Oe, Ie, Fe, ze, We, Ve, $e, Ue, qe, je, Ke, Ye, Ge, Xe, Je, Qe, Ze, et, tt, nt, rt, it, ot, at, st, lt])
}(this);
tinymce.ThemeManager.add("leanote", function(a) {
	function b() {
		function b(b) {
			var d, e = [];
			if (b) {
				var f = 0,
					g = ($("#mceToolbar").width() - 40, !1);
				return l(b.split(/[ ,]/), function(b) {
					function c() {
						var c = a.selection;
						"bullist" == h && c.selectorChanged("ul > li", function(a, c) {
							for (var d, e = c.parents.length; e-- && (d = c.parents[e].nodeName, "OL" != d && "UL" != d););
							b.active(a && "UL" == d)
						}), "numlist" == h && c.selectorChanged("ol > li", function(a, c) {
							for (var d, e = c.parents.length; e-- && (d = c.parents[e].nodeName, "OL" != d && "UL" != d););
							b.active(a && "OL" == d)
						}), b.settings.stateSelector && c.selectorChanged(b.settings.stateSelector, function(a) {
							b.active(a)
						}, !0), "leanote_code" != h && (b.settings.disabledStateSelector = "pre", c.selectorChanged(b.settings.disabledStateSelector, function(a) {
							b.disabled(a)
						}))
					}
					var h;
					if ("|" == b) d = null, g = !0;
						...
						type: b
					}, j.toolbar_items_size && (b.size = j.toolbar_items_size), e.push(b), d = null;
					else if (a.buttons[b]) {
						h = b, b = a.buttons[h], "function" == typeof b && (b = b()), b.type = b.type || "button", j.toolbar_items_size && (b.size = j.toolbar_items_size), b = k.create(b), f++;
						var i = ($("#popularToolbar").width(), b.renderHtml());
						g && ($("#popularToolbar").append('<span class="tool-split">|</span>'), g = !1), $("#popularToolbar").append(i), b.postRender(), a.initialized ? c() : a.on("init", c)
					}
				}), c.push({
					type: "toolbar",
					layout: "flow",
		...
		for (var c = [], d = 1; 10 > d && b(j["toolbar" + d]); d++);
		return c.length || b(j.toolbar || o), c
	}
	function c() {
		function b(b) {
			var c;
		...
		var d, e = [],
			f = [];
		if (j.menu) for (d in j.menu) f.push(d);
		else for (d in n) f.push(d);
	...
	function e(b, c) {
		...
		var e, f, g, h;
		e = a.getContainer(), f = a.getContentAreaContainer().firstChild, g = d(e), h = d(f), null !== b && (b = Math.max(j.min_width || 100, b), b = Math.min(j.max_width || 65535, b), m.css(e, "width", b + (g.width - h.width)), m.css(f, "width", b)), c = Math.max(j.min_height || 100, c), c = Math.min(j.max_height || 65535, c), m.css(f, "height", c), a.fire("ResizeEditor")
	}
	function f(b, c) {
	...
	function g() {
		function e() {
			if (l && l.moveRel && l.visible() && !l._fixed) {
				...
				l.fixed(!1).moveRel(c, a.rtl ? ["tr-br", "br-tr"] : ["tl-bl", "bl-tl"]).moveBy(d, e)
			}
		}
		function f() {
			l && (l.show(), e(), m.addClass(a.getBody(), "mce-edit-focus"))
		}
		function g() {
			l && (l.hide(), m.removeClass(a.getBody(), "mce-edit-focus"))
		}
		function h() {
			return l ? void(l.visible() || f()) : (l = i.panel = k.create({
			...
			}), l.renderTo(n || document.body).reflow(), d(l), f(), a.on("nodeChange", e), a.on("activate", f), void a.on("deactivate", g))
		}
		var l, n;
		return j.fixed_toolbar_container && (n = m.select(j.fixed_toolbar_container)[0]), j.content_editable = !0, setTimeout(function() {
			h()
		}), a.on("focus", h), a.on("remove", function() {
			l && (l.remove(), l = null)
		}), {}
	}
	function h(f) {
		var g, h, l, m = '<div id="noteTitleDiv"><input name="noteTitle" id="noteTitle" placeholder="Title" ></div>';
		m = "", b();
		var n = [j.menubar === !1 ? null : {
			type: "menubar",
			border: "0 0 1 0",
			items: c()
		},
		null,
		{
			...
			name: "iframe",
			layout: "stack",
			classes: "edit-area ifr",
			html: m,
			border: "1 0 0 0"
		}];
		return g = i.panel = k.create({
			type: "panel",
			classes: "tinymce",
			...
			h]
		}), j.readonly && g.find("*").disabled(!0), g.renderBefore(f.targetNode).reflow(), j.width && tinymce.DOM.setStyle(g.getEl(), "width", j.width), a.on("remove", function() {
			g.remove(), g = null
		}), d(g), {
...
tinymce.PluginManager.add("autolink", function(a) {
	...
	function e(a, b, c) {
		...
		i = h;
		do e(j, h >= 2 ? h - 2 : 0), f(j, h >= 1 ? h - 1 : 0), h -= 1, p = g.toString();
		while (" " != p && "" !== p && 160 != p.charCodeAt(0) && h - 2 >= 0 && p != c);
...
var LEAUI_DATAS = [];
tinymce.PluginManager.add("leaui_image", function(a, b) {
	function c(a, b) {
		function c(a, c) {
			d.parentNode.removeChild(d), b({
				width: a,
				height: c
			})
		}
		...
		var e = d.style;
		e.visibility = "hidden", e.position = "fixed", e.bottom = e.left = 0, e.width = e.height = "auto", document.body.appendChild(d)
	}
	function d() {
		function d() {
			var a = '<iframe id="leauiIfr" src="/album/index?' + (new Date).getTime() + '" frameborder="0"></iframe>';
			return a
		}
		var e = a.dom,
			f = a.selection.getContent(),
			g = /<img.*?\/>/g,
			h = f.match(g),
		...
		for (var k in h) {
			...
			if (l && "IMG" == l.nodeName) {
				var m = {};
				m.src = e.getAttrib(l, "data-src") || e.getAttrib(l, "src"), m.width = e.getAttrib(l, "width"), m.height = e.getAttrib(l, "height"), m.title = e.getAttrib(l, "title"), j.push(m)
			}
		}
		LEAUI_DATAS = j;
		var n = $(document).width() - 10;
		n > 805 && (n = 805);
		var o = $(document).height() - 100;
		o > 365 && (o = 365), win = a.windowManager.open({
			title: "Image",
			width: n,
			height: o,
			html: d(),
			buttons: [{
				...
				subtype: "primary",
				onclick: function(d) {
					for (var f = document.getElementById("leauiIfr").contentWindow, g = f.document.getElementById("preview"), h = g.childNodes, i = [], j = 0; j < h.length; ++j) {
						var d = h[j];
						if (d.firstChild && "IMG" == d.firstChild.nodeName) {
							var k = d.firstChild,
								l = {};
							l.src = k.getAttribute("src"), l.width = k.getAttribute("data-width"), l.height = k.getAttribute("data-height"), l.title = k.getAttribute("data-title"), i.push(l)
						}
					}
					for (var j in i) {
						var m, n = i[j],
							o = n.src;
						m = -1 != o.indexOf("http://") || -1 != o.indexOf("https://") ? o : b + "/" + o, n.src = m;
						var p = function(b) {
								var d = function(b, c) {
										var d, f = {};
										return f.id = "__mcenew" + c, f.src = "http://leanote.com/images/loading-24.gif", d = e.createHTML("img", f), a.insertContent(d), d = e.get(f.id), function(a) {
											a && a.width && (a.width > 600 && (a.width = 600), b.width = a.width), e.setAttrib(d, "src", b.src), e.setAttrib(d, "title", b.title), e.setAttrib(d, "id", null)
										}
									}(b, j);
								c(b.src, d)
							},
							q = "";
						if (fileIds = m.split("fileId="), 2 == fileIds.length && fileIds[1].length == "53aecf8a8a039a43c8036282".length && (q = fileIds[1]), q) {
							var r;
							Note && Note.getCurNote && (r = Note.getCurNote()), r && r.UserId != UserInfo.UserId ? !
							function(a) {
								ajaxPost("/file/copyImage", {
									...
									if (reIsOk(b) && b.Id) {
										var c = UrlPrefixHttps;
										a.src = c + "/api/file/getImage?fileId=" + b.Id
									}
									p(a)
								})
							}(n) : p(n)
	...
	a.addButton("leaui_image", {
		icon: "image",
		tooltip: "Insert/edit image",
		onclick: d,
		stateSelector: "img:not([data-mind-json])"
	}), a.addMenuItem("leaui_image", {
		icon: "image",
		text: "Insert image",
		onclick: d,
		context: "insert",
	...
	var e = !1;
	a.on("dragstart", function(a) {
		LEA.readOnly && (a.preventDefault(), a.stopPropagation()), e = !0
	}), a.on("dragend", function(a) {
		e = !1
...
var LEAUI_MIND = {};
tinymce.PluginManager.add("leaui_mindmap", function(a, b) {
	function c() {
		function b() {
			var b = a.settings.language,
				c = "/public/tinymce_4.1.9/js/tinymce/plugins/leaui_mindmap/mindmap/index.html?lang=" + LEA.locale,
				d = '<iframe id="leauiMindMapIfr" src="' + c + "?" + (new Date).getTime() + "&lang=" + b + '" frameborder="0"></iframe>';
			return d
		}
		var c = a.dom,
			d = a.selection.getContent(),
			e = /<img.*?\/>/g,
			f = d.match(e),
		...
		for (var h in f) {
			...
			var i = g.firstChild;
			if (i && "IMG" == i.nodeName) {
				LEAUI_MIND.json = c.getAttrib(i, "data-mind-json");
				break
			}
		}
		var j = window.innerWidth - 10,
			k = window.innerHeight - 150;
		win = a.windowManager.open({
			title: "Mind Map",
			width: j,
			height: k,
			html: b(),
			buttons: [{
				...
				onclick: function(b) {
					var c = this,
						d = document.getElementById("leauiMindMapIfr").contentWindow,
						e = d.km;
					e.exportData("png").then(function(b) {
						var d = JSON.stringify(e.exportJson());
						d = d.replace(/'/g, "\u0416");
						var f = '<img src="' + b + '" data-mce-src="-" data-mind-json=\'' + d + "'>";
						a.insertContent(f), c.parent().parent().close()
					})
				}
			}]
		})
	}
	a.addButton("leaui_mindmap", {
		icon: "mind",
...
tinymce.PluginManager.add("lists", function(a) {
	...
	a.on("init", function() {
		...
		function i(b, c) {
			...
			if (a.settings.forced_root_block && (c = c || a.settings.forced_root_block), c && (e = v.create(c), e.tagName === a.settings.forced_root_block && v.setAttribs(e, a.settings.forced_root_block_attrs), g.appendChild(e)), b) for (; d = b.firstChild;) {
				var i = d.nodeName;
		...
		function k(a, b, c) {
			...
			var e, f, g, h;
			for (g = v.select('span[data-mce-type="bookmark"]', a), c = c || i(b), e = v.createRng(), e.setStartAfter(b), e.setEndAfter(a), f = e.extractContents(), h = f.firstChild; h; h = h.firstChild) if ("LI" == h.nodeName && v.isEmpty(h)) {
				v.remove(h);
				break
			}
			v.isEmpty(f) || v.insertAfter(f, a), v.insertAfter(c, a), v.isEmpty(b.parentNode) && d(b.parentNode), v.remove(b), v.isEmpty(a) && v.remove(a)
		}
		function l(a) {
			var c, d;
		...
		function q() {
			...
			if (b.length) {
				var c, d, e = g(w.getRng(!0)),
					f = a.getBody();
				for (c = b.length; c--;) for (var i = b[c].parentNode; i && i != f;) {
					for (d = b.length; d--;) if (b[d] === i) {
						b.splice(c, 1);
						break
					}
					i = i.parentNode
		...
		f.backspaceDelete = function(c) {
			...
			function e(a, c) {
				...
				if (b(c.lastChild) && (e = c.lastChild), d = c.lastChild, d && "BR" == d.nodeName && a.hasChildNodes() && v.remove(d), v.isEmpty(c) && v.$(c).empty(), !v.isEmpty(a)) for (; d = a.firstChild;) c.appendChild(d);
	...
	d("tinymce/pasteplugin/Utils", ["tinymce/util/Tools", "tinymce/html/DomParser", "tinymce/html/Schema"], function(a, b, c) {
		...
		function e(d) {
			function e(a) {
				var b = a.name,
					c = a;
				if ("br" === b) return void(h += "\n");
				if (i[b] && (h += " "), j[b]) return void(h += " ");
				if (3 == a.type && (h += a.value), !a.shortEnded && (a = a.firstChild)) do e(a);
				while (a = a.next);
				k[b] && c.next && (h += "\n", "p" == b && (h += "\n"))
			}
			var f = new c,
				g = new b({}, f),
				h = "",
				i = f.getShortEndedElements(),
				j = a.makeMap("script noscript style textarea video audio iframe object", " "),
				k = f.getBlockElements();
			return e(g.parse(d)), h
		}
		return {
			filter: d,
			innerText: e
		...
		return function(d) {
			function e(a, b) {
				ajaxPost("/file/copyHttpImage", {
					src: a
				}, function(a) {
					if (reIsOk(a)) {
						var c = urlPrefix + "/file/outputImage?fileId=" + a.Id,
							e = d.dom;
						for (var f in b) {
							var g = b[f],
								h = e.get(g);
			...
			function f(a, b) {
				var c, f = d.dom;
				if (d.settings.paste_data_images || (a = a.replace(/<img[^>]+src=\"data:image[^>]+>/g, "")), c = d.fire("BeforePastePreProcess", {
					content: a
				}), c = d.fire("PastePreProcess", c), a = c.content, !c.isDefaultPrevented()) {
					if (d.hasEventListeners("PastePostProcess") && !c.isDefaultPrevented()) {
						var g = f.add(d.getBody(), "div", {
							style: "display:none"
						}, a);
						c = d.fire("PastePostProcess", {
							node: g
						}), f.remove(g), a = c.node.innerHTML
					}
					if (!c.isDefaultPrevented()) {
						var h = d.selection.getNode();
						if ("PRE" == h.nodeName) {
							if (!b) try {
								b = $(a).text()
							} catch (i) {}
							b = b.replace(/</g, "&lt;"), b = b.replace(/>/g, "&gt;"), d.insertRawContent(b)
						} else if (q.copyImage) {
							var j = UrlPrefix,
								k = {},
								l = (new Date).getTime();
							try {
								for (var m = $("<div>" + a + "</div>"), n = m.find("img"), o = 0; o < n.length; ++o) {
									var p = n.eq(o),
										r = p.attr("src");
									if (-1 == r.indexOf(j)) {
										l++;
										var s = "__LEANOTE_IMAGE_" + l;
										p.attr("id", s), k[r] ? k[r].push(s) : k[r] = [s]
									}
								}
								d.insertContent(m.html());
								for (var r in k) {
									var t = k[r];
									e(r, t)
								}
			...
			function g(a) {
				...
				var e, g = d.dom.getParent(d.selection.getStart(), d.dom.isBlock),
					h = d.settings.forced_root_block;
				h && (e = d.dom.createHTML(h, d.settings.forced_root_block_attrs), e = e.substr(0, e.length - 3) + ">"), g && /^(PRE|DIV)$/.test(g.nodeName) || !h ? a = c.filter(a, [
					[/\n/g, "<br>"]
				]) : (a = c.filter(a, [
					[/\n\n/g, "</p>" + e],
					[/^(.*<\/p>)(<p>)$/, e + "$1"],
					[/\n/g, "<br />"]
				]), -1 != a.indexOf("<p>") && (a = e + a)), f(a, b)
			}
			function h() {
				var a = d.dom,
					b = d.getBody(),
					c = d.dom.getViewPort(d.getWin()),
					e = d.inline ? b.scrollTop : c.y,
					f = d.inline ? b.clientHeight : c.h;
				i(), n = a.add(d.getBody(), "div", {
					id: "mcepastebin",
					contentEditable: !0,
					"data-mce-bogus": "1",
					style: "position: absolute; top: " + (e + 20) + "px;width: 10px; height: " + (f - 40) + "px; overflow: hidden; opacity: 0"
				}, s), a.setStyle(n, "left", "rtl" == a.getStyle(b, "direction", !0) ? 65535 : -65535), a.bind(n, "beforedeactivate focusin focusout", function(a) {
					a.stopPropagation()
				}), o = d.selection.getRng(), n.focus(), d.selection.select(n, !0)
			}
			function i() {
				n && (d.dom.unbind(n), d.dom.remove(n), o && d.selection.setRng(o)), p = !1, n = o = null
			}
			function j() {
				return n ? n.innerHTML : s
			}
			function k(a) {
				var b = {},
					c = a.clipboardData || d.getDoc().dataTransfer;
				if (c && c.types) {
					b["text/plain"] = c.getData("Text");
					for (var e = 0; e < c.types.length; e++) {
						var f = c.types[e];
						b[f] = c.getData(f)
					}
				}
			...
			function m(a) {
				var b;
				if (a.clipboardData ? b = a.clipboardData.items : a.originalEvent && a.originalEvent.clipboardData && (b = a.originalEvent.clipboardData), !b) return !1;
				for (var c = 0; c < b.length; c++) if (0 === b[c].type.indexOf("image")) return !0;
				return !1
			}
			var n, o, p, q = this,
				r = 0,
				s = "%MCEPASTEBIN%";
			d.on("keydown", function(c) {
				if (!c.isDefaultPrevented() && (b.metaKeyPressed(c) && 86 == c.keyCode || c.shiftKey && 45 == c.keyCode)) {
					if (l()) return;
					if (p = c.shiftKey && 86 == c.keyCode, c.stopImmediatePropagation(), r = (new Date).getTime(), a.ie && p) return c.preventDefault(), void d.fire("paste", {
						ieFake: !0
					});
					h()
				}
				...
				if (l()) return void i();
				if (m(b)) return void i();
				var e = k(b),
					o = (new Date).getTime() - r < 100,
					t = "text" == q.pasteFormat || p;
				o || b.preventDefault(), !a.ie || o && !b.ieFake || (h(), d.dom.bind(n, "paste", function(a) {
					a.stopPropagation()
				}), d.getDoc().execCommand("Paste", !1, null), e["text/html"] = j(), i()), setTimeout(function() {
					var a = j();
					n && n.firstChild && "mcepastebin" === n.firstChild.id && (t = !0), i(), (a != s && o || (a = e["text/html"] || e["text/plain"] || s, a != s)) && (t ? g(e["text/plain"] || c.innerText(a)) : f(a, e["text/plain"]))
				}, 0)
			}), q.pasteHtml = f, q.pasteText = g
		}
		...
		function g(a) {
			return /class="?Mso|style="[^"]*\bmso-|style='[^'']*\bmso-|w:WordDocument/i.test(a)
		}
		function h(h) {
			var i = h.settings;
			h.on("BeforePastePreProcess", function(j) {
				function k(a) {
					function b(a, b, g, h) {
						var i = a._listLevel || f;
						i != f && (f > i ? c && (c = c.parent.parent) : (d = c, c = null)), c && c.name == g ? c.append(a) : (d = d || c, c = new e(g, 1), h > 1 && c.attr("start", "" + h), a.wrap(c)), a.name = "li", b.value = "";
						var j = b.next;
						j && 3 == j.type && (j.value = j.value.replace(/^\u00a0+/, "")), i > f && d && d.lastChild.append(c), f = i
					}
					for (var c, d, f = 1, g = a.getAll("p"), h = 0; h < g.length; h++) if (a = g[h], "p" == a.name && a.firstChild) {
						for (var i = "", j = a.firstChild; j && !(i = j.value);) j = j.firstChild;
						if (/^\s*[\u2022\u00b7\u00a7\u00d8\u25CF]\s*$/.test(i)) {
							b(a, j, "ul");
							continue
						}
						if (/^\s*\w+\.$/.test(i)) {
							var k = /([0-9])\./.exec(i),
								l = 1;
							k && (l = parseInt(k[1], 10)), b(a, j, "ol", l);
							continue
						}
						c = null
					}
				...
				function l(b, c) {
					if ("p" === b.name) {
						var d = /mso-list:\w+ \w+([0-9]+)/.exec(c);
						d && (b._listLevel = parseInt(d[1], 10))
					}
					if (h.getParam("paste_retain_style_properties", "none")) {
						var e = "";
						if (a.each(h.dom.parseStyle(c), function(a, b) {
							switch (b) {
							case "horiz-align":
								return void(b = "text-align");
							case "vert-align":
								return void(b = "vertical-align");
							case "font-color":
							case "mso-foreground":
								return void(b = "color");
							case "mso-background":
				...
				var m, n, o = j.content;
				if (m = i.paste_retain_style_properties, m && (n = a.makeMap(m)), i.paste_enable_default_filters !== !1 && g(j.content)) {
					j.wordContent = !0, o = f.filter(o, [/<!--[\s\S]+?-->/gi, /<(!|script[^>]*>.*?<\/script(?=[>\s])|\/?(\?xml(:\w+)?|img|meta|link|style|\w:\w+)(?=[\s\/>]))[^>]*>/gi, [/<(\/?)s>/gi, "<$1strike>"],
						[/&nbsp;/gi, "\xa0"],
					...
					var p = i.paste_word_valid_elements;
					p || (p = "@[style],-strong/b,-em/i,-span,-p,-ol,-ul,-li,-h1,-h2,-h3,-h4,-h5,-h6,-table,-tr,-td[colspan|rowspan],-th,-thead,-tfoot,-tbody,-a[!href],sub,sup,strike,br");
					var q = new c({
						valid_elements: p
					}),
						r = new b({}, q);
					r.addAttributeFilter("style", function(a) {
						for (var b, c = a.length; c--;) b = a[c], b.attr("style", l(b, b.attr("style"))), "span" != b.name || b.attributes.length || b.unwrap()
					});
					var s = r.parse(o);
					k(s), j.content = new d({}, q).serialize(s)
				}
			})
		}
		return h.isWordContent = g, h
		...
		return function(e) {
			...
			function g(a) {
				return a = d.filter(a, [/^[\s\S]*<!--StartFragment-->|<!--EndFragment-->[\s\S]*$/g, [/<span class="Apple-converted-space">\u00a0<\/span>/g, "\xa0"], /<br>$/])
			}
			function h(a) {
			...
			function i(a) {
				return (e.settings.paste_remove_styles || e.settings.paste_remove_styles_if_webkit !== !1) && (a = a.replace(/ style=\"[^\"]+\"/g, "")), a
			}
			a.webkit && (f(i), f(g)), a.ie && f(h)
		}
		...
		a.add("paste", function(a) {
			...
			var g, h = this,
				i = a.settings;
			h.clipboard = g = new b(a), h.quirks = new d(a), h.wordFilter = new c(a), g.copyImage = !0, a.settings.paste_as_text && (h.clipboard.pasteFormat = "text"), i.paste_preprocess && a.on("PastePreProcess", function(a) {
...
function() {
	function a(a, b, c, d, e) {
		...
		if (l = b.ownerDocument, m = e.getBlockElements(), n = e.getWhiteSpaceElements(), o = e.getShortEndedElements(), k = g(b)) {
			if (a.global) for (; j = a.exec(k);) p.push(f(j, d));
	...
	function b(b) {
		...
		function g(a) {
			var c, e = [];
			if (c = tinymce.toArray(b.getBody().getElementsByTagName("span")), c.length) for (var f = 0; f < c.length; f++) {
				var g = d(c[f]);
		...
		j.init = function(a) {
			...
			for (c = c !== !1, m = b.getBody(), l = tinymce.toArray(m.getElementsByTagName("span")), h = 0; h < l.length; h++) {
				var r = d(l[h]);
				if (null !== r && r.length) if (n = o = parseInt(r, 10), e || n === k) {
					for (a.length ? (l[h].firstChild.nodeValue = a, f(l[h])) : i(l[h]); l[++h];) if (n = d(l[h]), null !== r && r.length) {
						if (n !== o) {
							h--;
							break
						}
...
tinymce.PluginManager.add("leanote_nav", function(a) {
	function b() {
		var b = a.getBody(),
			d = $(b),
			e = d.html();
		if (c != e) {
			c = e;
			for (var f = d.find("h1,h2,h3,h4,h5,h6").toArray(), g = "<ul>", h = 0; h < f.length; ++h) {
				var i = $(f[h]).text(),
					j = f[h].tagName.toLowerCase();
				g += '<li class="nav-' + j + '"><a data-a="' + j + "-" + encodeURI(i) + '" onclick="scrollTo(this, \'' + j + "', '" + i + "')\">" + i + "</a></li>"
			}
			g += "</ul>", $("#leanoteNavContent").html(g).height("auto"), f.length || $("#leanoteNavContent").html("&nbsp; Nothing...");
			var k = $("#leanoteNavContent").height(),
				l = $("#editorContent").height() - 29;
			k > l && $("#leanoteNavContent").height(l)
		}
	}
	var c = "";
	a.on("init", function() {
		window.setTimeout(function() {
			b(), a.on("setcontent beforeadd undo paste", b), a.on("ExecCommand", function(a) {
				b()
...
tinymce.PluginManager.add("leanote_code", function(a, b) {
	function c(a) {
		return a ? ("object" == typeof a && (a = $(a).html()), a.replace(/\<br *\/*\>/gi, "\n").replace(/<\/(p|li|div|ul|ol|hr)>/, "\n").replace(/(<([^>]+)>)/gi, "").replace(/\n\n/g, "\n")) : a
	}
	function d(a) {
		return a ? ("object" == typeof a && (a = $(a).html()), a.replace(/\n/g, "<br />")) : a
	}
	function e() {
		var a = $("#editorContent").children(),
			b = a && a.length > 0 ? a[a.length - 1] : null;
		b && "P" == b.tagName || $("#editorContent").append('<p><br data-mce-bogus="1"></p>')
	}
	function f(a) {
		if (!LEA.readOnly) {
			h = tinymce.activeEditor;
			var b, f = h.selection.getNode(),
				g = h.selection.getContent(),
				i = LeaAce.isInAce(f),
				j = !1,
				k = !1;
			i && (j = i[0], k = i[1]), $("#editorContent .toggle-raw").remove();
			var l = 'class="brush:' + a + '"';
			if (a && "convert" != a) {
				if (j && j.session.setMode("ace/mode/" + a), k || "PRE" != f.nodeName || (k = $(f)), k) {
					var m = LeaAce.getPreBrush(k);
					return void k.removeClass(m).addClass("brush:" + a)
				}
			} else if (a && ("BODY" == f.nodeName || "editorContent" == $(f).attr("id"))) return;
			if (LeaAce.canAce()) {
				var n = LeaAce.getAceId();
				if (LeaAce.disableAddHistory(), j) {
					var o = j.getValue();
					o = o.replace(/</g, "&lt;"), o = o.replace(/>/g, "&gt;"), o = o.replace(/\n/g, "<br />"), k.replaceWith("<p>" + o + "</p>"), j.destroy()
				} else {
					if ("PRE" == f.nodeName) {
						var k = $(f),
							o = k.html();
						return o && (o = o.replace(/\n/g, "<br />")), void k.replaceWith("<p>" + o + "</p>")
					}
					var b = g;
					if (!b && ("BODY" == f.nodeName || "editorContent" == $(f).attr("id"))) return;
					b ? (b = c(b), h.insertContent('<pre id="' + n + '" ' + l + ">" + b + "</pre>")) : (b = c(f), $(f).replaceWith("<pre id='" + n + "'" + l + ">" + b + "</pre>"));
					var j = LeaAce.initAce(n);
					j && (j.focus(), a && "convert" != a && j.session.setMode("ace/mode/" + a), e())
				}
				LeaAce.resetAddHistory()
			} else if ("PRE" != f.nodeName && (f = $(f).closest("pre").get(0)), f && "PRE" == f.nodeName) {
				var k = $(f),
					o = k.html();
				o && (o = o.replace(/\n/g, "<br />")), k.replaceWith("<p>" + o + "</p>")
			} else {
				try {
					b = $.trim($(g).text())
				} catch (p) {}
				...
				var q = null,
					n = LeaAce.getAceId();
				b ? (b = d(b), q = '<pre id="' + n + '" ' + l + ">" + b + "</pre>", h.insertContent(q)) : f ? (b = d(f), q = '<pre id="' + n + '" ' + l + ">" + b + "</pre>", $(f).replaceWith(q)) : (q = '<pre id="' + n + '" ' + l + ">" + b + "</pre>", h.insertContent(q)), q && e()
			}
		}
	}
	function g() {
		return function() {
			...
			a.on("nodeChange", function() {
				...
				try {
					...
					if ("PRE" != d.nodeName && (d = $(d).closest("pre").get(0)), d) {
						var e = LeaAce.isInAce(d),
							f = !1,
							g = !1;
						if (e || "PRE" == d.nodeName) {
							e ? (f = e[0], g = e[1]) : g = $(d);
							var h = LeaAce.getPreBrush(g);
							c = $.trim(h.split(":")[1]), b.diableValue("convert", !1)
						} else b.diableValue("convert", !0)
					}
				} catch (i) {
					log(i)
				}
	...
	var h = a;
	a.addButton("leanote_code", function() {
		var a = ["Convert Code:convert", "CSS:css", "HTML:html", "Javascript:javascript", "C/C++:c_cpp", "C#:csharp", "Java:java", "Objective-c:objectivec", "PHP:php", "Python:python", "Ruby:ruby", "Shell:sh", "Delphi:delphi", "Golang:golang", "Erlang:erlang", "Groovy:groovy", "Latex:latex", "Xml:xml", "ActionScript:actionScript", "Matlab:matlab", "Scala:scala", "Sql:sql"],
			b = [];
		for (var c in a) {
			var d = a[c].split(":");
			b.push({
		...
		return {
			...
			fixedWidth: !0,
			onselect: function(a) {
				a.control.settings.value && f(a.control.settings.value)
			},
			onPostRender: g(b)
		}
	}), a.addButton("leanote_inline_code", {
		icon: "code",
		tooltip: "Inline Code",
		stateSelector: "code",
		onclick: function() {
			a.execCommand("mceToggleFormat", !1, "code")
		}
	}), LeaAce.canAce() && a.addButton("leanote_ace_pre", {
		icon: "ace-pre",
		tooltip: "Toggle ace with raw html",
		active: LeaAce.isAce === !1,
		onclick: function() {
			LeaAce.isAce === !1 ? (this.active(!1), LeaAce.isAce = !0, LeaAce.initAceFromContent(a)) : (this.active(!0), LeaAce.allToPre(a), LeaAce.isAce = !1)
		}
	}), h.addCommand("toggleCode", f), h.addShortcut("ctrl+shift+c", "", "toggleCode"), h.addShortcut("meta+shift+c", "", "toggleCode"), LeaAce.canAce() && a.on("keydown", function(a) {
		var b = LeaAce.nowIsInAce();
		...
		if (9 == b && !a.shiftKey) {
			var c = h.selection.getNode();
			return c && ("LI" == c.nodeName || $(c.closest("li")).length > 0) ? !0 : (h.insertContent("&nbsp;&nbsp;&nbsp;&nbsp;"), a.preventDefault(), a.stopPropagation(), !1)
		}
	})
});
...
function(a, b) {
	...
	d("tinymce/tableplugin/TableGrid", ["tinymce/util/Tools", "tinymce/Env"], function(a, c) {
		...
		return function(f, g) {
				...
				F = [], G = 0, e(["thead", "tbody", "tfoot"], function(b) {
					...
					e(c, function(c, f) {
						f += a, e(L.select("> td, > th", c), function(a, c) {
							var e, g, h, i;
							if (F[f]) for (; F[f][c];) c++;
							for (h = d(a, "rowspan"), i = d(a, "colspan"), g = f; f + h > g; g++) for (F[g] || (F[g] = []), e = c; c + i > e; e++) F[g][e] = {
								part: b,
								real: g == f && e == c,
								elm: a,
								rowspan: h,
			...
			function q(a, b, c, d) {
				var e, f, g, h, i;
				for (e = F[b][a].elm.parentNode, g = 1; c >= g; g++) if (e = L.getNext(e, "tr")) {
					for (f = a; f >= 0; f--) if (i = F[b + g][f].elm, i.parentNode == e) {
						for (h = 1; d >= h; h++) L.insertAfter(o(i), i);
						break
					}
					if (-1 == f) for (h = 1; d >= h; h++) e.insertBefore(o(e.cells[0]), e.cells[0])
				}
			}
			function r() {
				e(F, function(a, b) {
			...
			function s(b, c, d) {
				...
				if (b ? (f = A(b), g = f.x, i = f.y, m = g + (c - 1), n = i + (d - 1)) : (H = I = null, e(F, function(a, b) {
					...
					for (r(), h(), s = j(g, i).elm, k(s, "colSpan", m - g + 1), k(s, "rowSpan", n - i + 1), q = i; n >= q; q++) for (o = g; m >= o; o++) F[q] && F[q][o] && (b = F[q][o].elm, b != s && (u = a.grep(b.childNodes), e(u, function(a) {
						s.appendChild(a)
			...
			function t(a) {
				...
				if (e(F, function(b, d) {
					...
					for (h = 0; h < F[0].length; h++) if (F[c][h] && (f = F[c][h].elm, f != g)) {
						if (a) {
			...
			function D(a) {
				...
				if (I = A(a), H && I) {
					...
					for (k = c; e >= k; k++) for (j = b; d >= j; j++) a = F[k][j], a.real && (h = a.colspan - 1, i = a.rowspan - 1, h && j + h > f && (f = j + h), i && k + i > g && (g = k + i));
					for (L.removeClass(L.select("td.mce-item-selected,th.mce-item-selected"), "mce-item-selected"), k = c; g >= k; k++) for (j = b; f >= j; j++) F[k][j] && L.addClass(F[k][j].elm, "mce-item-selected")
				}
			}
			function E(a, b) {
				var c, d, e;
		...
		return function(c) {
			...
			function h() {
				c.on("KeyDown SetContent VisualAid", function() {
					var a;
					for (a = c.getBody().lastChild; a; a = a.previousSibling) if (3 == a.nodeType) {
			...
			function j() {
				c.on("keydown", function(b) {
					if ((b.keyCode == a.DELETE || b.keyCode == a.BACKSPACE) && !b.isDefaultPrevented()) {
						...
						if (d) {
							for (var e = c.dom.select("td,th", d), f = e.length; f--;) if (!c.dom.hasClass(e[f], "mce-item-selected")) return;
		...
		return function(d) {
			...
			o.tableProps = function() {
				...
				function j() {
					function c(a, b, d) {
						if ("TD" === a.tagName || "TH" === a.tagName) v.setStyle(a, b, d);
						else if (a.children) for (var e = 0; e < a.children.length; e++) c(a.children[e], b, d)
					}
					var e;
