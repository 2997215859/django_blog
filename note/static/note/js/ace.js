(function() {
	...
	var u = !i.isMac || !i.isOpera || "KeyboardEvent" in window ?
	function(e) {
	...
	var r = e("../lib/event"),
		...
		l = function(e, t) {
			function w(e) {
				if (p) return;
				p = !0;
				if (L) t = 0, r = e ? 0 : n.value.length - 1;
				else var t = e ? 2 : 1,
					r = 2;
				try {
			...
			if (i.isOldIE) {
				var x = !1,
					T = function(e) {
						...
						var t = n.value;
						if (p || !t || t == l) return;
						if (e && t == l[0]) return N.schedule();
						O(t), x = !0, E(), x = !1
					},
					N = o.delayedCall(T);
				r.addListener(n, "propertychange", T);
				var C = {
					13: 1,
					27: 1
				};
				r.addListener(n, "keyup", function(e) {
					p && (!n.value || C[e.keyCode]) && setTimeout(I, 0);
					if ((n.value.charCodeAt(0) || 0) < 129) return N.call();
					p ? F() : j()
			...
			var k = function(e) {
					c ? c = !1 : S(n) ? (t.selectAll(), w()) : L && w(t.selection.isEmpty())
				},
				L = null;
			...
			var A = !1,
				O = function(e) {
					L && (e = L(e), L = null), h ? (w(), e && t.onPaste(e), h = !1) : e == l.charAt(0) ? A ? t.execCommand("del", {
						source: "ace"
					}) : t.execCommand("backspace", {
						source: "ace"
					}) : (e.substring(0, 2) == l ? e = e.substr(2) : e.charAt(0) == l.charAt(0) ? e = e.substr(1) : e.charAt(e.length - 1) == l.charAt(0) && (e = e.slice(0, -1)), e.charAt(e.length - 1) == l.charAt(0) && (e = e.slice(0, -1)), e && t.onTextInput(e)), A && (A = !1)
				},
				M = function(e) {
					if (p) return;
					var t = n.value;
				...
				D = function(e, i) {
					...
					_(e, s) ? (i ? t.onCut() : t.onCopy(), r.preventDefault(e)) : (c = !0, n.value = s, n.select(), setTimeout(function() {
			...
			var j = function(e) {
					...
					p = {}, t.onCompositionStart(), setTimeout(F, 0), t.on("mousedown", I), t.selection.isEmpty() || (t.insert(""), t.session.markUndoGroup(), t.selection.clearSelection()), t.session.markUndoGroup()
				},
				F = function() {
					if (!p || !t.onCompositionUpdate || t.$readOnly) return;
					var e = n.value.replace(/\x01/g, "");
					if (p.lastValue === e) return;
					t.onCompositionUpdate(e), p.lastValue && t.undo(), p.lastValue = e;
					if (p.lastValue) {
				...
				I = function(e) {
					...
					var i = setTimeout(function() {
						...
						var e = n.value.replace(/\x01/g, "");
						if (p) return;
						e == r.lastValue ? E() : !r.lastValue && e && (E(), O(e))
					});
					L = function(n) {
						return i && clearTimeout(i), n = n.replace(/\x01/g, ""), n == r.lastValue ? "" : (r.lastValue && i && t.undo(), n)
					}, t.onCompositionEnd(), t.removeListener("mousedown", I), e.type == "compositionend" && r.range && t.selection.setRange(r.range), f && M()
				},
				q = o.delayedCall(F, 50);
			r.addListener(n, "compositionstart", j), i.isGecko ? r.addListener(n, "text", function() {
				q.schedule()
				...
				A = !0, w(t.selection.isEmpty()), t._emit("nativecontextmenu", {
					target: t,
					domEvent: e
				...
				t.renderer.$keepTextAreaAtCursor && (t.renderer.$keepTextAreaAtCursor = null), clearTimeout(R), i.isWin && !i.isOldIE && r.capture(t.container, h, U)
	...
	(function() {
		this.setDefaultHandler = function(e) {
			...
			}, o = u.exec("insertstring", this.$editor, t)), o && this.$editor._signal("keyboardActivity", s), o
	...
	(function() {
		...
		this.normalizeRules = function() {
			...
			}), Object.getPrototypeOf(i) && (i.__proto__ = null), this.$keywordList = Object.keys(i), e = null, n ?
			function(e) {
		...
		this.tokenRe = new RegExp("^[" + o.packages.L + o.packages.Mn + o.packages.Mc + o.packages.Nd + o.packages.Pc + "\\$_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + o.packages.L + o.packages.Mn + o.packages.Mc + o.packages.Nd + o.packages.Pc + "\\$_]|\\s])+", "g"), this.getTokenizer = function() {
			...
			if (!this.completionKeywords) {
				...
				for (var r in t) {
					...
					else if (typeof i[s].token == "object") for (var u = 0, a = i[s].token.length; u < a; u++) if (/keyword|support|storage/.test(i[s].token[u])) {
	...
	(function() {
		...
		this.onPaste = function(t, n) {
			var r = {
				...
				i = (new Date).getTime();
			if (e && i - e < 100) return;
			e = i, this.commands.exec("paste", this, r)
	...
	(function() {
		i.implement(this, o), this.setSession = function(e) {
			...
			var t = e.start.row,
				n = e.end.row - t;
			if (n !== 0) if (e.action == "remove") this.$annotations.splice(t, n + 1, null);
			else {
				var r = new Array(n + 1);
		...
		r.implement(this, u), this.EOF_CHAR = "\u00b6", this.EOL_CHAR_LF = "\u00ac", this.EOL_CHAR_CRLF = "\u00a4", this.EOL_CHAR = this.EOL_CHAR_LF, this.TAB_CHAR = "\u2014", this.SPACE_CHAR = "\u00b7", this.$padding = 0, this.$updateEolChar = function() {
			...
			var i = this,
				...
				u = function(e, n, r, o, u) {
					...
					return r ? i.showInvisibles ? "<span class='ace_invisible ace_invisible_space ace_invalid'>" + i.SPACE_CHAR + "</span>" : s.stringRepeat("\u00a0", e.length) : (t += 1, "<span class='ace_cjk' style='width:" + i.config.characterWidth * 2 + "px'>" + e + "</span>")
				},
				a = r.replace(o, u);
	...
	}, t.EditSession = o, t.UndoManager = u, t.version = "1.2.3"
});
(function() {
...
// 浠ヤ笅闈瀉ce.js鏂囦欢閲岀殑, 鍙槸markdown缂栬緫鍣ㄨ鐢�, mode-ace_mode.js       
ace.define("ace/mode/css_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules"], function(e, t, n) {
...
}), ace.define("ace/mode/ace_mode_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules", "ace/mode/html_highlight_rules"], function(e, t, n) {
	"use strict";
	var r = e("ace/lib/oop"),
		i = e("ace/mode/text_highlight_rules").TextHighlightRules,
		s = e("ace/mode/html_highlight_rules").HtmlHighlightRules,
		o = function() {
	...
	r.inherits(o, i), t.MarkdownHighlightRules = o
...
}), ace.define("ace/mode/ace_mode", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/tokenizer", "ace/mode/ace_mode_highlight_rules", "ace/mode/folding/markdown", "ace/range"], function(e, t, n) {
	"use strict";
	var r = e("ace/lib/oop"),
		i = e("ace/mode/text").Mode,
		s = e("ace/tokenizer").Tokenizer,
		o = e("./ace_mode_highlight_rules").MarkdownHighlightRules,
		u = e("ace/mode/folding/markdown").FoldMode,
		a = e("ace/range").Range,
		f = window.MD.aceEditor,
		l = function() {
			var e = new o;
	...
	(function() {
		this.type = "text", this.lineCommentStart = ">", this.getNextLineIndent = function(e, t, n) {
			if (c !== !0 || e != "listblock" && e != "listblock-start" || !/^\s*(?:[-+*]|\d+\.)\s+$/.test(t)) {
				c = !1;
				if (e == "listblock") {
					var o = /^(\s*)(?:([-+*])|(\d+)\.)(\s+)/.exec(t);
					if (!o) return "";
					var u = o[2];
					return u || (u = parseInt(o[3], 10) + 1 + "."), c = !0, o[1] + u + o[4]
				}
				return this.$getIndent(t)
			}
			var r = f.$getSelectedRows();
			if (r.last > 1) {
				var i = new a(r.last - 2, f.session.getLine(r.last - 2).length, r.last - 1, f.session.getLine(r.last - 1).length),
					s = f.session.getTextRange(i);
				/^\s*(?:[-+*]|\d+\.)\s+$/.test(s) && f.session.remove(i)
			}
			return c = !1, this.$getIndent(t)
		}
	}).call(l.prototype), t.Mode = l
})